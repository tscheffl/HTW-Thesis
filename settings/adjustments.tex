...
% wählen Sie hier die für Ihr Latex-System nötige Quellenverarbeitung:
\usepackage[style=alphabetic, backend=biber,   natbib=true]{biblatex}.  %Biber
%\usepackage[style=alphabetic, backend=bibtex, natbib=true]{biblatex} %Bibtex
%
